...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/landing/light/index.css" />
...
<body>
    ...
    <main>
        ...
        <section class="standard-row section-one">
            ...
            <img src="<?= base_url() ?>assets/landing/light/shapes/circleFive.png" class="shape circleFive">
            <img src="<?= base_url() ?>assets/landing/light/shapes/circleFour.png" class="shape circleFour">
            <img src="<?= base_url() ?>assets/landing/light/shapes/circleOne.png" class="shape circleOne">
            <img src="<?= base_url() ?>assets/landing/light/shapes/circleThree.png" class="shape circleThree">
            <img src="<?= base_url() ?>assets/landing/light/shapes/circleTwo.png" class="shape circleTwo">
            <img src="<?= base_url() ?>assets/landing/light/shapes/star1.png" class="shape starOne">
            <img src="<?= base_url() ?>assets/landing/light/shapes/star2.png" class="shape starTwo">
            <img src="<?= base_url() ?>assets/landing/light/shapes/TriangleOne.png" class="shape tri">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1420 300">
            <path fill="transparent" fill-opacity="1" stroke="#F03A76" stroke-width="5" stroke-linecap="round"
        ...
        <section class="standard-row section-two">
            ...
            <div class="section-two-top">
                ...
                <div class="section-two-top-grid">
                    ...
                    <div class="section-two-top-card">
                        <img class="section-two-top-card-image"
                            src="<?= $this->crud_model->get_image_url('product', $secondProduct['id']) ?>"
                    ...
                    <div class="section-two-top-card">
                        <img class="section-two-top-card-image"
                            src="<?= $this->crud_model->get_image_url('product', $thirdProduct['id']) ?>"
                            alt="services-offered">
                    ...
                    <div class="section-two-top-card">
                        <img class="section-two-top-card-image"
                            src="<?= $this->crud_model->get_image_url('product', $fourthProduct['id']) ?>"
                            alt="services-offered">
            ...
            <div class="section-two-bottom">
                <div class="section-two-bottom-left">
                    <img class="section-two-bottom-left-image"
                        src="<?= $this->crud_model->get_image_url('product', $fifthProduct['id']) ?>">
                </div>
        ...
        <section class="standard-row section-three">
            ...
            <div class="section-three-right">
                <img class="section-three-right-image"
                    src="<?= $this->crud_model->get_image_url('product', $sixthProduct['id']) ?>">
            </div>
        </section>
        <?php endforeach; ?>
        ...
        <section class="standard-row section-four">
            <div class="section-four-left">
                <div class="section-four-left-image-container">
                    ...
                    <img class="section-four-left-image"
                        src="<?= $this->crud_model->get_image_url('product', $seventhProduct['id']) ?>">
                </div>
            </div>
                                ...
                                <div class="row p-2 bg-white border rounded">
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <form action="<?= base_url('confirm-order') ?>" method="post">
                                            <input type="hidden" name="product_id" value="<?= $page['encrypted_id'] ?>"
                                                required="">
