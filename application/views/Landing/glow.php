...
<body>
    ...
    <main>
        ...
        <section class="standard-row section-one">
            ...
            <img src="<?= base_url() ?>assets/landing/glow/shapes/circleFive.png" class="shape circleFive">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/circleFour.png" class="shape circleFour">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/circleOne.png" class="shape circleOne">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/circleThree.png" class="shape circleThree">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/circleTwo.png" class="shape circleTwo">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/star1.png" class="shape starOne">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/star2.png" class="shape starTwo">
            <img src="<?= base_url() ?>assets/landing/glow/shapes/TriangleOne.png" class="shape tri">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1420 300">
            <path fill="#5129A6" fill-opacity="1" stroke="#1BF2A380" stroke-width="10" stroke-linecap="round"
