...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/landing/neutral/index.css" />
...
<body>
    ...
    <main>
        ...
        <section class="standard-row section-one">
            ...
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/circleFive.png" class="shape circleFive">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/circleFour.png" class="shape circleFour">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/circleOne.png" class="shape circleOne">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/circleThree.png" class="shape circleThree">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/circleTwo.png" class="shape circleTwo">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/star1.png" class="shape starOne">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/star2.png" class="shape starTwo">
            <img src="<?= base_url() ?>assets/landing/neutral/shapes/TriangleOne.png" class="shape tri">
            <?php 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#F2E5E4" fill-opacity="1"
