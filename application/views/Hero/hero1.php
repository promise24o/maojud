...
<head>
    ...
    <style>
        ...
        .btn-order-now {
            background: linear-gradient(104.58deg, #5097A5 0%, #5E4A72 100.64%);
            display: block;
            width: 75% !important;
                    ...
                    <div class="off-canvas-contact-widget">
                        <ul>
                            <li><i class="fa fa-mobile"></i> <a
                                    href="#"><?=  $this->config->item('site_phone'); ?></a> </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="contact-info pt-0">
                                        ...
                                        <p>
                                           Send Us a message. We'll keep your email address private and get back to you quickly.
                                        </p>
                                        <ul>
                                            <li>
                                                <i class="fa fa-fax"></i> Address : <?= $this->config->item('site_address') ?>
                                            </li>
                                    ...
                                    <div class="form mb-5">
                                        <form action="<?= base_url('confirm-order') ?>" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="single-input-item">
                                                        <textarea required placeholder="Enter Delivery Address" name="address"></textarea>
                                                    </div>
                                                </div>
