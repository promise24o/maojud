...
<body style="background: linear-gradient( 135deg , #F8BAA0 0%, #FFFFFF, #B2E0FB 100.64%)">
    <!-- Start Header Area -->
                            ...
                            <div class="">
                                <div class="">
                                    <div class="hero-slider-content slide-1">
                                        ...
                                        <h2 class="slide-title" style="color: #000000;">New Collection</h2>
                                        <p class="slide-desc" style="color: #000000;">Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed do eiusmod tempor incidid</p>
                                        <div class="price mt-4">
                                            <h3 style="color: #000000;">$ 100.00</h3>
                                        </div>
                                        <a href="#" class="btn" style="background-color: transparent; border: 2px black solid; color:#000000; border-radius: 30px;">SHOP NOW <i class="fa fa-arrow-right"></i></a>
                                        <p class="items-sold" style="color: #000000;">* No. of Item(s) Sold: 10</p>
                                    </div>
                                </div>
                            </div>
                        </div>
