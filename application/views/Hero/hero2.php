...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/hero/2/index.css">
...
<body>
    <main class="main-container">
        ...
        <section class="container main-section-one">
            ...
            <div class="section-one-left">
                ...
                <h2 class="section-one-left-heading">
                    Purchase Your <span class="underline">Shoes</span> Now
                </h2>
                <p class="section-one-para">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                    Dolor morbi velit turpis et dolor sit morbi odio id. Aliquam ultricies tortor ac.
                </p>
                <button class="section-one-button">Shop Now</button>
            </div>

            <div class="section-one-right">
                <img class="eclipse" src="<?= base_url() ?>assets/hero/2/Images/Vertical.png">
                <img class="horizontal" src="<?= base_url() ?>assets/hero/2/Images/Horizontal.png">
                <img class="Banner" src="<?= base_url() ?>assets/hero/2/Images/Banner.png">
            </div>
        </section>
        ...
        <section class="container prod-one">
            ...
            <div class="products">
            <div class="card">
                <div class="product-image"><img src="<?= base_url() ?>assets/hero/2/Images/P-1.png"></div>
            ...
            <div class="card">
                <div class="product-image"><img src="<?= base_url() ?>assets/hero/2/Images/P-2.png"></div>
                <p class="category">Sneakers</p>
                <p class="product-name">Nike Running Shoes</p>
                <div class="germ">
                    <p class="prdouct-price">$ 100 <small>price</small></p>
            ...
            <div class="card">
                <div class="product-image"><img src="<?= base_url() ?>assets/hero/2/Images/P-3.png"></div>
                <p class="category">Sneakers</p>
                <p class="product-name">Nike Running Shoes</p>
                <div class="germ">
                    <p class="prdouct-price">$ 100 <small>price</small></p>
            ...
            <div class="card">
                <div class="product-image"><img src="<?= base_url() ?>assets/hero/2/Images/P-4.png"></div>
                <p class="category">Sneakers</p>
                <p class="product-name">Nike Running Shoes</p>
                <div class="germ">
                    <p class="prdouct-price">$ 100 <small>price</small></p>
